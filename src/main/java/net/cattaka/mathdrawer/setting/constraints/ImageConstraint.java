...
public class ImageConstraint extends SettingConstraint<String> {
	private String[] items;
	
	public ImageConstraint(String name, String description, boolean nullable, String defaultValue) {
		super(name, description, nullable, defaultValue);
		this.items = new String[0];
	}

	public MdSettingEditor createMdSettingEditor(DrawerUtil drawerUtil) {
		this.items = drawerUtil.createPresetImageNameArray();
