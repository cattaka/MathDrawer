...
public class CustomDrawerConstraint extends SettingConstraint<String> {
	private String[] items;
	
	public CustomDrawerConstraint(String name, String description, boolean nullable, String defaultValue) {
		super(name, description, nullable, defaultValue);
		this.items = new String[0];
	}

	public MdSettingEditor createMdSettingEditor(DrawerUtil drawerUtil) {
		this.items = drawerUtil.createCustomDrawerProcessNameArray();
